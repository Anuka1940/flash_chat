...
from flash_chat import app, db, bcrypt, mail
from flash_chat.form import (RegistrationForm, LoginForm, UpdateAccountForm,
                             PostForm, RequestResetForm, ResetPasswordForm)
from flash_chat.models import User, Post
